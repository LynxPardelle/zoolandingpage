...
When the class depends on shared browser state, prefer a conditional resolver instead of adding component-specific config fields:
...
This keeps authored dynamic styling portable across components because it reuses `valueInstructions` and the condition DSL rather than adding special-case renderer inputs.
  ...
  template: `
    <section class="heroSection">
      <div class="ank-maxWidth-800px">
        <h1
          class="ank-fontSize-32px ank-fontSize-md-48px ank-fontSize-lg-56px ank-fontWeight-bold ank-color-brand-dark ank-marginBottom-24px"
        >
          {{ title }}
        </h1>
        <p
          class="ank-fontSize-18px ank-fontSize-md-20px ank-color-brand-medium ank-lineHeight-1_6 ank-marginBottom-32px"
        >
          {{ subtitle }}
        </p>
  ...
  template: `
    <section class="sectionContainer">
      <div class="ank-textAlign-center ank-marginBottom-48px">
        <h2 class="ank-fontSize-36px ank-fontWeight-bold ank-color-brand-dark">Interactive Tutorial</h2>
      </div>
  ...
  template: `
    <form [formGroup]="leadForm" (ngSubmit)="onSubmit()" class="ank-maxWidth-500px ank-margin-0__auto">
      <div class="ank-marginBottom-24px">
        <label class="ank-display-block ank-marginBottom-8px ank-fontWeight-600 ank-color-brand-dark"> Email * </label>
        <input
          type="email"
      ...
      <div class="ank-marginBottom-24px">
        <label class="ank-display-block ank-marginBottom-8px ank-fontWeight-600 ank-color-brand-dark"> Message </label>
        <textarea
...
export class LeadCaptureFormComponent implements AfterRender {
  ...
  constructor(private fb: FormBuilder, private _ank: NGXAngoraService) {}
...
export class SketchAnimationComponent implements AfterRender {
  ...
  ngAfterRender(): void {
    ...
    this._ank.pushCombos({
      sketchContainer: ['ank-width-100per', 'ank-maxWidth-400px', 'ank-margin-0__auto', 'ank-color-brand-primary'],
    });
...
<div class="ank-p-16px ank-p-sm-24px ank-p-md-32px ank-p-lg-48px">
  <h1 class="ank-fontSize-24px ank-fontSize-sm-32px ank-fontSize-md-40px ank-fontSize-lg-48px">Responsive Heading</h1>
...
<div
  class="ank-display-grid ank-gridTemplateColumns-1fr ank-gridTemplateColumns-sm-repeatSD2COM1frED ank-gridTemplateColumns-lg-repeatSD3COM1frED ank-gridTemplateColumns-xl-repeatSD4COM1frED ank-gap-20px"
>
