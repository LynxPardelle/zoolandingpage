...
| `zoolanding-commerce` (local only; no GitHub remote) | Commercial policy resolution, an undeployed three-table foundation, and pure provider-neutral money/catalog/inventory/subscription/shipping/fiscal invariants | n/a | Local `AGENTS.md`, then README; TASK-025 through TASK-027 are local-only and AWS deployment remains blocked |
