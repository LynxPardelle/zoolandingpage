# Automatic Config Creator (WIP)

This folder is reserved for tooling/docs that help generate `TGenericComponent` configurations automatically (for example, from a short brief).
