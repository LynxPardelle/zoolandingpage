...
- 2026-05-18 23:10 CT: For Zoosite Google Ads readiness, keep confirmed price clarity (`Desde $3,000 MXN`) visible early on home, `/sitios-web-para-pymes`, and `/contacto`; keep WhatsApp as the primary conversion action with a mobile fixed CTA; do not publish unconfirmed claims such as `Listo en 5 dias`, `100% facturable`, or `Soporte humano incluido`; and treat Google tag/dataLayer, GCLID persistence, legal pages, consent, SSR JSON-LD/hreflang, and robots/sitemap metadata as app/platform/legal handoff work until implemented.
