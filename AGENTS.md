...
6. If the task touches an existing local draft, inspect `drafts/{domain}/ai_notes/`, `drafts/{domain}/findings/`, and `drafts/{domain}/errors-reports/` when those folders exist.
7. Read the implementation docs that match the task, especially under [docs/](./docs/).
