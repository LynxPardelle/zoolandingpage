...
const SPANISH_TRANSLATIONS: TLandingPageTranslations = {
    ...
    calculator: {
        ...
        visitsPerMonthSuffix: 'visitas/mes',
        inputVisitorsLabel: 'Ingresar visitas:',
        inputVisitorsAriaLabel: 'Ingresar visitas mensuales',
        businessSizeLabel: 'Tamano de tu negocio',
        industryLabel: 'Industria',
        growthPotentialTitle: 'Tu Potencial de Crecimiento',
        basedOnCurrentConfig: 'Basado en tu configuracion actual',
        resultsBasedHint: 'Resultados basados en estadisticas reales de la industria',
        projectionsDisclaimer: '*Proyecciones basadas en estadisticas de la industria y casos de exito reales',
        requestConsultingCta: 'Solicitar Consultoria Personalizada',
        placeholderMonthlyIncreaseValue: '+$15000',
        placeholderConversionImprovementValue: '3.4x',
    ...
    ui: {
        ...
        accessibility: {
            ...
            openMenu: 'Abrir menu',
            mobileMenuAriaLabel: 'Menu de navegacion movil',
            primaryNavigation: 'Navegacion principal',
            dialog: 'Dialogo',
            analyticsConsentDialog: 'Dialogo de consentimiento de analiticas',
            dialogOpened: 'Dialogo abierto',
        ...
        debugPanel: {
            downloadDraftPayloads: 'Descargar payloads draft',
            writeDraftsToDisk: 'Escribir drafts a disco',
            configIssues: 'Problemas de configuracion',
            analyticsLatest: 'Analiticas (recientes)',
        ...
        common: {
            ...
            dismissNotification: 'Cerrar notificacion',
            verified: 'Verificado',
        },
    },
    demo: {
        ...
        toast: {
            demoTitle: "Demostración avanzada de notificaciones toast",
            basicTypesTitle: "Tipos básicos de toast",
            advancedFeaturesTitle: "Funciones avanzadas",
            positionConfigTitle: "Posición y configuración",
            currentConfigurationTitle: "Configuración actual",
            positionLabel: "Posición",
            maxVisibleLabel: "Máximo visible",
            defaultAutoCloseLabel: "Cierre automático por defecto",
            ...
            multipleMessages: ["Primera notificación", "Segunda notificación", "Tercera notificación", "Cuarta notificación"],
...
const ENGLISH_TRANSLATIONS: TLandingPageTranslations = {
    ...
    calculator: {
        ...
        visitsPerMonthSuffix: 'visits/month',
        inputVisitorsLabel: 'Enter visitors:',
        inputVisitorsAriaLabel: 'Enter monthly visitors',
        businessSizeLabel: 'Business size',
        industryLabel: 'Industry',
        growthPotentialTitle: 'Your Growth Potential',
        basedOnCurrentConfig: 'Based on your current setup',
        resultsBasedHint: 'Results based on real industry statistics',
        projectionsDisclaimer: '*Projections based on industry statistics and real success cases',
        requestConsultingCta: 'Request Personalized Consulting',
        placeholderMonthlyIncreaseValue: '+$15000',
        placeholderConversionImprovementValue: '3.4x',
    ...
    ui: {
        ...
        accessibility: {
            ...
            dialog: 'Dialog',
            analyticsConsentDialog: 'Analytics consent dialog',
        ...
        debugPanel: {
            ...
            analyticsLatest: 'Analytics (latest)',
    ...
    demo: {
        ...
        toast: {
            demoTitle: "Advanced Toast Notifications Demo",
            basicTypesTitle: "Basic Toast Types",
            advancedFeaturesTitle: "Advanced Features",
            positionConfigTitle: "Position and Configuration",
            ...
            multipleMessages: ["First notification", "Second notification", "Third notification", "Fourth notification"],
