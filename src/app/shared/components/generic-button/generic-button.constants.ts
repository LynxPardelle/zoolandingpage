...
export const GENERIC_BUTTON_SIZES: Record<ButtonSize, string> = {
  sm: 'ank-px-0_75rem ank-py-0_5rem ank-fs-1_5rem',
  md: 'ank-px-1_25rem ank-py-0_75rem ank-fs-1_5rem',
  lg: 'ank-px-1_5rem ank-py-1rem ank-fs-1_5rem',
};

export const GENERIC_BUTTON_ICON_CLASS = 'ank-w-1rem ank-h-1rem ank-me-1rem';
