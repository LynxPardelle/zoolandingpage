...
export const containers: TGenericComponent[] = [
    /* Landing Page Root */
    {
        id: 'landingPage',
        type: 'container',
    ...
    // Hero Image Mockup
    {
        ...
        type: 'container',
        valueInstructions: 'set:config.classes,concat,literal,ank-position-absolute ank-inset-0 ank-bgCover ank-borderRadius-1rem ank-opacity-15 ank-backgroundImage-,i18n,hero.backgroundImage',
        config: {
            tag: 'div',
            classes: '',
        }
