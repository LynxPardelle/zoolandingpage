...
import { ThemeMode, ThemeColors, ThemeConfig } from '../types/theme.types';
...
export class ThemeService {
  ...
  private _applyTheme(): void {
    ...
    const currentThemeConfig: ThemeConfig = this.activeTheme() === 'dark' ? this._darkThemeConfig : this._lightThemeConfig;
