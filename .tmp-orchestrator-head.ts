...
export class ConfigurationsOrchestratorService {
  ...
  private static readonly HERO_BADGES_COUNT = 5;
  private static readonly FEATURES_COUNT = 6;
  private static readonly SERVICES_COUNT = 3;
  private static readonly TESTIMONIALS_COUNT = 3;
  ...
  private readonly footerTranslations = {
    ...
    es: {
      ...
      termsAriaLabel: 'T├®rminos de servicio',
  ...
  readonly accordions: TGenericComponent[] = [
    {
      ...
      config: {
        items: () =>
          this.globalI18n.getOr<readonly { id: string; title: string; content: string }[]>('faq', []).map((faqItem) => ({
            id: faqItem.id,
            title: faqItem.title,
  ...
  readonly buttons: TGenericComponent[] = [
    ...
    {
      id: 'secondaryCTA',
      condition: () => !!this.globalI18n.get('hero.secondary'),
      type: 'button',
    ...
    /* Header */
    {
      ...
      valueInstructions: 'set:config.label,themePick,ÔÿÇ´©Å,­ƒîÖ',
      config: {
        id: 'toggleTheme',
        label: '',
        classes:
  ...
  readonly media: TGenericComponent[] = [
    /* Header */
    // (empty) ÔÇö header logo is now a text link
  ];
  readonly containers: TGenericComponent[] = [
    ...
    {
      id: "badgesContainer",
      condition: () => this.globalI18n.getOr<readonly unknown[]>('hero.badges', []).length > 0,
      type: 'container',
      config: {
        tag: 'div',
        classes:
    ...
    // Badge List Container
    {
      ...
      config: {
        ...
        components: Array.from({ length: ConfigurationsOrchestratorService.HERO_BADGES_COUNT }, (_, index) => `badgeContainer${ index + 1 }`),
      },
    },
    // Badge Containers
    ...Array.from({ length: ConfigurationsOrchestratorService.HERO_BADGES_COUNT }, (_, index) => ({
      id: `badgeContainer${ index + 1 }`,
      condition: () => !!this.globalI18n.getOr<readonly unknown[]>('hero.badges', [])[index],
      type: 'container',
      config: {
        tag: 'div',
    ...
    {
      id: "heroImageMockup",
      condition: () => !!this.globalI18n.get<string>('hero.backgroundImage'),
      type: 'container',
      config: {
        tag: 'div',
        classes: 'ank-position-absolute ank-inset-0 ank-bgCover ank-borderRadius-1rem ank-opacity-15 ank-backgroundImage-' + (this.globalI18n.get<string>('hero.backgroundImage') ?? ''),
      }
    },
    // Hero Browser Mockup
    {
    ...
    },
    {
      ...
      config: {
        tag: 'div',
        classes: 'gridCol2',
        components: Array.from({ length: ConfigurationsOrchestratorService.FEATURES_COUNT }, (_, index) => `featuresCard${ index + 1 }`),
      }
    },
    ...
    },
    {
      ...
      config: {
        tag: 'div',
        classes: 'gridCol2',
        components: Array.from({ length: ConfigurationsOrchestratorService.SERVICES_COUNT }, (_, index) => `servicesCard${ index + 1 }`),
      }
    },
    ...
    },
    {
      ...
      config: {
        tag: 'div',
        classes: 'gridCol2',
        components: Array.from({ length: ConfigurationsOrchestratorService.TESTIMONIALS_COUNT }, (_, index) => `testimonialsCard${ index + 1 }`),
      }
    },
  ...
  readonly cards: TGenericComponent[] = [
    /* Features Section */
    ...Array.from({ length: ConfigurationsOrchestratorService.FEATURES_COUNT }, (_unused: unknown, index: number) => ({
    ...
    /* Services Section */
    ...Array.from({ length: ConfigurationsOrchestratorService.SERVICES_COUNT }, (_unused: unknown, index: number) => ({
    ...
    /* Testimonials Section */
    ...Array.from({ length: ConfigurationsOrchestratorService.TESTIMONIALS_COUNT }, (_unused: unknown, index: number) => ({
  ...
  readonly texts: TGenericComponent[] = [
    ...
    // Badges
    ...Array.from({ length: ConfigurationsOrchestratorService.HERO_BADGES_COUNT }, (_unused: unknown, index: number) => ({
    ...
    // Final CTA Trust (Line 1)
    {
      ...
      type: 'text',
      valueInstructions: 'set:config.text,langPick,Ô¡É Measurement from day 1 ÔÇó ­ƒöÆ SSL and hosting included ÔÇó ÔÜí Fast delivery,Ô¡É Medici├│n desde el d├¡a 1 ÔÇó ­ƒöÆ SSL y hosting incluido ÔÇó ÔÜí Entrega r├ípida',
      config: {
        tag: 'p',
    ...
    // Final CTA Trust (Row 2)
    {
      ...
      type: 'text',
      valueInstructions: 'set:config.text,langPick,­ƒÆ¼ Continuous support,­ƒÆ¼ Soporte continuo',
      config: {
        tag: 'span',
        text: '',
      }
    },
    {
      ...
      type: 'text',
      valueInstructions: 'set:config.text,langPick,­ƒôè Optional simple reports,­ƒôè Reportes simples opcionales',
      config: {
        tag: 'span',
        text: '',
      }
    },
    {
      ...
      type: 'text',
      valueInstructions: 'set:config.text,langPick,­ƒîÉ Search engine optimization,­ƒîÉ Optimizaci├│n para buscadores',
      config: {
        tag: 'span',
        text: '',
      }
    },
    {
      ...
      type: 'text',
      valueInstructions: 'set:config.text,langPick,Measurement from day 1,Medici├│n desde el d├¡a 1',
      config: {
        tag: 'span',
        text: '',
      }
    ...
    },
    {
      ...
      type: 'text',
      valueInstructions: 'set:config.text,langPick,Fast delivery,Entrega r├ípida',
      config: {
        tag: 'span',
        text: '',
      }
    ...
    },
    {
      ...
      type: 'text',
      valueInstructions: 'set:config.text,langPick,Search engine optimization,Optimizaci├│n para buscadores',
      config: {
        tag: 'span',
        text: '',
      }
